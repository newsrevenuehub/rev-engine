...
export const EMAIL_CANCELATION_KB_URL =
  'https://news-revenue-hub.atlassian.net/wiki/spaces/REVENGINE/pages/2411986966/How+are+receipts+and+transactional+communications+sent?parentProduct=JSM-Portal&parentProductContentContainerId=10035#Cancelation-emails';
export const EMAIL_PAYMENT_CHANGE_KB_URL =
  'https://news-revenue-hub.atlassian.net/wiki/spaces/REVENGINE/pages/2411986966/How+are+receipts+and+transactional+communications+sent?parentProduct=JSM-Portal&parentProductContentContainerId=10035#Subscription-updates-emails';
