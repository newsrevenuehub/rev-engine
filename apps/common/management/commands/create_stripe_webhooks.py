...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        contributions_stripe_secret = create_stripe_webhook(
            ...
            webhook_url=options.get("url-contributions", settings.SITE_URL + reverse("stripe-webhooks-contributions")),
        )
        ...
        upgrade_stripe_secret = create_stripe_webhook(
            ...
            webhook_url=options.get("url-upgrades", settings.SITE_URL + reverse("organization-handle-stripe-webhook")),
        )
