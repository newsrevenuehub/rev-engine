...
import { DONATIONS_SLUG, PAGES_SLUG, MAIN_CONTENT_SLUG, ORGANIZATION_SLUG } from 'routes';
  ...
  return (
    <S.DashboardSidebar>
      <S.NavList>
        ...
        <S.NavItem to={PAGES_SLUG} onClick={handleClick} disabled={!shouldAllowDashboard}>
          Pages
        </S.NavItem>
