...
describe('DSwag', () => {
  ...
  it('displays the contribution threshold', () => {
    ...
    expect(
      screen.getByText('Give a total of mock-currency-symbol123.45 mock-currency-code / year or more to be eligible')
    ).toBeVisible();
  });
