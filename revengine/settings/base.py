...
# https://docs.djangoproject.com/en/4.2/ref/settings/#databases
# Default changed to BigAutoField in 3.2 https://docs.djangoproject.com/en/4.2/releases/3.2/#customizing-type-of-auto-created-primary-keys
...
LOGGING = {
    ...
    "loggers": {
        ...
        # see https://docs.djangoproject.com/en/4.2/topics/logging/#django-security
