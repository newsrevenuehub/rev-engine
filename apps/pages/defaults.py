    ...
    return [
        {
            ...
            "uuid": str(uuid4()),
            "content": (
                '<h2 style="text-align:center;">Support our journalism today.</h2>\n<p style="text-align:center;">This'
                " work doesn't happen without your support. Contribute today!</p>\n"
            ),
            "requiredFields": [],
        },
        {
        ...
        },
        {
            ...
            "uuid": str(uuid4()),
            "content": (
                '<p style="text-align:center;">Have questions or want to change a recurring contribution? Contact us at YOUR EMAIL'
                " ADDRESS HERE. <br><br>Prefer to mail a check? Our mailing address is YOUR MAILING ADDRESS HERE.<br><br>Contributions"
                " or gifts to YOUR ORGANIZATION NAME HERE are tax deductible. Our tax ID is YOUR TAX ID HERE.&nbsp;</p>\n"
            ),
            "requiredFields": [],
        },
    ]
