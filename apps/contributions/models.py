...
class Contributor(IndexedTimeStampedModel):
    ...
    email = models.EmailField(blank=False, null=False, unique=True, db_collation="case_insensitive")
...
class Contribution(IndexedTimeStampedModel):
    ...
    contributor = models.ForeignKey("contributions.Contributor", on_delete=models.PROTECT)
