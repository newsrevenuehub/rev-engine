...
class RevenueProgram(IndexedTimeStampedModel):
    ...
    org_google_analytics_v3_domain = models.CharField(max_length=300, null=True, blank=True)
    org_google_analytics_v3_id = models.CharField(max_length=50, null=True, blank=True)
