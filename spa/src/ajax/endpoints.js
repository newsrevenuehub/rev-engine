...
export const AUTHORIZE_ONE_TIME_STRIPE_PAYMENT_ROUTE = 'contributions/authorize-one-time-payment';
export const AUTHORIZE_STRIPE_SUBSCRIPTION_ROUTE = 'contributions/authorize-subscription';
