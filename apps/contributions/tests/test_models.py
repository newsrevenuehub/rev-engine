...
class TestContributionModel:
    ...
    def test_card_when_sourced_from_invoice_settings(self, customer_card_from_invoice_settings, mocker):
        mocker.patch("stripe.Customer.retrieve", return_value=customer_card_from_invoice_settings)
        contribution = ContributionFactory(provider_customer_id="cus_123")
        assert contribution.card == customer_card_from_invoice_settings.invoice_settings.default_payment_method
